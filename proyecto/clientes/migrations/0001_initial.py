    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('segmento', models.CharField(choices=[('minorista', 'Minorista'), ('corporativo', 'Corporativo'), ('vip', 'VIP')], default='minorista', max_length=20, verbose_name='Segmento')),
                ('beneficio_segmento', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
